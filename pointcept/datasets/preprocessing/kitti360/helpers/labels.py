...
labels = [
    ...
    Label("out of roi", 3, -1, -1, "void", 0, False, True, True, (0, 0, 0)),
    Label("static", 4, -1, -1, "void", 0, False, True, True, (0, 0, 0)),
    Label("dynamic", 5, -1, -1, "void", 0, False, True, True, (111, 74, 0)),
    Label("ground", 6, -1, -1, "void", 0, False, True, True, (81, 0, 81)),
    Label("road", 7, 1, 0, "flat", 1, False, False, False, (128, 64, 128)),
    Label("sidewalk", 8, 3, 1, "flat", 1, False, False, False, (244, 35, 232)),
    Label("parking", 9, 2, -1, "flat", 1, False, True, True, (250, 170, 160)),
    Label("rail track", 10, 10, -1, "flat", 1, False, True, True, (230, 150, 140)),
    ...
    Label(
        "guard rail", 14, 30, -1, "construction", 2, False, True, True, (180, 165, 180)
    ),
    Label("bridge", 15, 31, -1, "construction", 2, False, True, True, (150, 100, 100)),
    Label("tunnel", 16, 32, -1, "construction", 2, False, True, True, (150, 120, 90)),
    Label("pole", 17, 21, 5, "object", 3, True, False, True, (153, 153, 153)),
    Label("polegroup", 18, -1, -1, "object", 3, False, True, True, (153, 153, 153)),
    ...
    Label("trailer", 30, 15, -1, "vehicle", 7, True, True, True, (0, 0, 110)),
    ...
    Label("stop", 36, 29, -1, "construction", 2, True, True, True, (150, 120, 90)),
    Label("smallpole", 37, 22, 5, "object", 3, True, True, True, (153, 153, 153)),
    Label("lamp", 38, 25, -1, "object", 3, True, True, True, (0, 64, 64)),
    Label("trash bin", 39, 26, -1, "object", 3, True, True, True, (0, 128, 192)),
    Label("vending machine", 40, 27, -1, "object", 3, True, True, True, (128, 64, 0)),
    Label("box", 41, 28, -1, "object", 3, True, True, True, (64, 64, 128)),
    Label(
        "unknown construction", 42, 35, -1, "void", 0, False, True, True, (102, 0, 0)
    ),
    Label("unknown vehicle", 43, 36, -1, "void", 0, False, True, True, (51, 0, 51)),
    Label("unknown object", 44, 37, -1, "void", 0, False, True, True, (32, 32, 32)),
    Label("license plate", -1, -1, 19, "vehicle", 7, False, True, True, (0, 0, 142)),
]
